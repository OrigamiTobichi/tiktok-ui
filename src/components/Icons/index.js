function UploadIcon({ className, width = '2rem', height = '2rem' }) {
  return (
    <svg
      className={className}
      width={width}
...
function PaperPlane({ className, width = '2.7rem', height = '3.3rem' }) {
  return (
    <svg
      className={className}
      width={width}
...
function Messages({ className, width = '3.2rem', height = '3.2rem' }) {
  return (
    <svg
      className={className}
      width={width}
...
function IconSearch({ className, width = '2.4rem', height = '2.4rem' }) {
  return (
    <svg
      className={className}
      width={width}
...
export { UploadIcon, PaperPlane, Messages, IconSearch };
